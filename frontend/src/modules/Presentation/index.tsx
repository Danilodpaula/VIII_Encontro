...
// import graxura_pequena1 from "../../assets/engrave_small_2.svg";
import graxura_pequena2 from "../../assets/engrave_small_1.svg";
  ...
  return (
    <>
      <Container id="apresentacao">
        <WrapperAll>
          <DividerImage1 src={graxura_pequena2} />
          <TitleWrapper>
          ...
          <PresentationContent>
            <PresentationText>
              ...
              <p>
                ...
                , o evento propõe uma análise profunda sobre as transformações
                que moldam nossa sociedade, inspirada na icônica obra de Glauber
                Rocha.
              </p>
              ...
              <p>
                ...
                sobre os desafios e transformações sociais, políticas e
                culturais da contemporaneidade, explorando a noção de "Terra em
                Transe" como um eixo reflexivo acerca dos efeitos dos eventos
                climáticos extremos.
              </p>
              ...
              <p>
                ...
                <strong>
                  palestras, mesas-redondas, fórum do Observatório da Cidadania
                  e Relações de Poder, exposição com linguagem multimodal,
        ...
        <DividerImage2 src={graxura_pequena2} />
      </Container>
    </>
  );
}
