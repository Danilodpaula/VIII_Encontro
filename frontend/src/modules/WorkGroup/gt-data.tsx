export const GT_DATA = [
  {
    title: "GT 1 – Políticas Públicas, Cidadania e Meio Ambiente (Manaus)",
    coordination:
      "Profa. Dra. Izaura Rodrigues Nascimento (PPGSP/UEA); Profa. Dra. Lucilene Ferreira de Melo (PPGSSA/UFAM)",
    description: `O GT tem o objetivo de promover o debate sobre os temas Políticas Públicas, Cidadania e Meio Ambiente, abrigando resultados de pesquisas em:
    
1. Políticas Públicas: sobre o contexto neoliberal, a crise política institucional brasileira na contemporaneidade e os impactos das políticas públicas brasileiras. O capital social e o controle social;

2. Cidadania: a sociedade contemporânea e os desafios à cidadania efetiva, sobretudo de grupos em situação de vulnerabilidade social; movimentos sociais, organizações não-governamentais e cidadania;

3. Meio Ambiente: avanços e recuos na proteção ambiental no Brasil e na Amazônia, globalização e sustentabilidade;

4. Sociodiversidade e questões ambientais: mudanças climáticas e seus impactos nos povos indígenas e populações tradicionais, racismo ambiental e justiça ambiental.`,
  },
  {
...
Este Grupo de Trabalho se propõe como um espaço para divulgação de trabalhos monográficos ou de reflexões teórico-metodológicas que explorem a relação entre as religiões/religiosidades e as manifestações culturais na Amazônia, em especial as festas e o folclore. 

Também acolherá propostas que versem sobre aspectos pontuais de uma dessas áreas isoladamente ou que analisem as formas pelas quais essas instâncias da vida aparecem na literatura. 

Trata-se de uma proposta aberta a diálogos inter-poli-transdisciplinares, aceitando estudos que partam da Geografia, História, Antropologia, Sociologia, Teologia e do campo das Letras e Artes. Nosso objetivo é aprofundar, na medida do possível, as relações existentes entre a pesquisa, as práticas e as representações sociais, apontando para a função social da ciência na conformação de uma sociedade mais democrática, onde diferentes manifestações identitárias possam conviver legitimamente e pacificamente no espaço público.`,
  },
  {
    title:
      "GT 4 – Descrição e Análise da Diversidade Linguística Amazônica e suas Interfaces (Manaus)",
    coordination:
      "Prof. Dr. Sanderson Castro Soares de Oliveira (PPGL/FLET/UFAM, FPI/DEEI/UFAM); Profª Drª Jeivine Justiniano (ENS/UEA)",
    description: `O estado do Amazonas guarda a maior diversidade linguística do Brasil, com pouco mais de 60 línguas indígenas faladas em seu território (Oliveira e Justiniano 2022, 60), o que significa um terço das línguas autóctones ainda faladas no Brasil. 

Além dessas, ainda são faladas línguas de sinais que são escassamente estudadas (Ferreira 2023, 40-1). Essa diversidade é completada pelas variedades da língua portuguesa faladas no estado e que apresentam características próprias (Cruz, 2010), bem como pelas línguas de imigração como o japonês e o espanhol venezuelano, sobre os quais não há estudos sistemáticos. 

A cada língua falada, associam-se conhecimentos ímpares que dizem respeito não apenas às estruturas próprias de cada uma, mas também às suas culturas, modos de ver o mundo, estruturas e capacidades cognitivas das sociedades que as falam. 

Esse conhecimento também se relaciona diretamente com o bioma amazônico, e estudos demonstram que a extinção de uma língua leva, necessariamente, à perda de conhecimento sobre a biodiversidade. 
