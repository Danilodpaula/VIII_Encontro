export const EXHIBITION_CONTENT = {
  ...
  sections: [
    ...
    {
      region: "Centro-Oeste",
      heading: "O Pantanal em Perigo",
      content: `
          O Pantanal, um dos maiores biomas úmidos do planeta, sofre com secas extremas e incêndios cada vez mais frequentes. 
          As altas temperaturas e a escassez de chuvas prejudicam a fauna e a flora locais, ameaçando a sobrevivência de diversas espécies.`,
      image:
        "https://imagens.ebc.com.br/AYxGxkogz-1PWAls2_l1vtoGkXI=/1170x700/smart/https://agenciabrasil.ebc.com.br/sites/default/files/thumbnails/image/_ja_2165_0.jpg?itok=ZXtrpUXD",
    },
    {
      region: "Sudeste",
      heading: "Ondas de Calor e Estresse Térmico",
      content: `
          No Sudeste, ondas de calor recordes têm afetado grandes centros urbanos como o Rio de Janeiro e São Paulo. 
          O aumento da temperatura impacta a saúde da população, sobrecarregando o sistema elétrico e exigindo medidas urgentes de adaptação.`,
      image:
  ...
  conclusion: `
      A crise climática não é mais uma previsão distante: ela está acontecendo agora. A conscientização e a ação coletiva são fundamentais 
      para mitigar seus impactos e construir um futuro mais sustentável.`,
};
